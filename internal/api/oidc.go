...
func (h OIDCHandler) IdpIdentityGet(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.IdpIdentity{}
...
func (h OIDCHandler) IdpIdentityList(ctx *gin.Context) {
...
// @param id path int true "IdpIdentity ID"
func (h OIDCHandler) IdpIdentityDelete(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.IdpIdentity{}
...
func (h OIDCHandler) UserGet(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.User{}
	db := h.preLoad(h.DB(ctx), clause.Associations)
	err := db.First(m, id).Error
...
// @success 200 {object} []api.User
// @router /users [get]
func (h OIDCHandler) UserList(ctx *gin.Context) {
	var list []model.User
	db := h.preLoad(h.DB(ctx), clause.Associations)
	err := db.Find(&list).Error
	if err != nil {
...
// @param id path int true "User ID"
func (h OIDCHandler) UserDelete(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.User{}
	err := h.DB(ctx).First(m, id).Error
	if err != nil {
...
func (h OIDCHandler) RoleGet(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.Role{}
	db := h.preLoad(h.DB(ctx), clause.Associations)
	err := db.First(m, id).Error
...
// @success 200 {object} []api.Role
// @router /roles [get]
func (h OIDCHandler) RoleList(ctx *gin.Context) {
	var list []model.Role
	db := h.preLoad(h.DB(ctx), clause.Associations)
	err := db.Find(&list).Error
	if err != nil {
...
// @param id path int true "Role ID"
func (h OIDCHandler) RoleDelete(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.Role{}
	err := h.DB(ctx).First(m, id).Error
	if err != nil {
...
func (h OIDCHandler) PermissionGet(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.Permission{}
	db := h.preLoad(h.DB(ctx), clause.Associations)
	err := db.First(m, id).Error
...
func (h OIDCHandler) PermissionList(ctx *gin.Context) {
...
// @param id path int true "Permission ID"
func (h OIDCHandler) PermissionDelete(ctx *gin.Context) {
	id := h.pk(ctx)
	m := &model.Permission{}
	err := h.DB(ctx).First(m, id).Error
	if err != nil {
